...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Given a Lutus Notes calendar url, parse events into ruby class. Includes basic query options.'
  spec.summary       = 'Library to fetch and parse events from a Lotus Notes calendar.'
